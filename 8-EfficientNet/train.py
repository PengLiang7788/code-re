...
parser = argparse.ArgumentParser("Pytorch Efficient Training")
...
parser.add_argument('--name', default='efficientnet_b0', type=str, help='name of experiment')
...
data_transforms = {
    "train": transforms.Compose([
        ...
        transforms.RandomCrop(img_size[model_name]),  # 随机裁剪224x224大小的图像
    ...
    "val": transforms.Compose([
        ...
        transforms.RandomCrop(img_size[model_name]),
        transforms.ToTensor(),
