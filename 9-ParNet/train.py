...
from model.net import create_model

parser = argparse.ArgumentParser("Pytorch ParNet Training")
...
parser.add_argument('--name', default='ParNet-S', type=str, help='name of experiment')
